 ...
 */
package br.usp.ime.ccsl.cogroo.oooext.addon.conf;
...
public class AddOnConfiguration extends DefaultConfiguration {
    ...
    public static final String CONFIGURATION_ROOT_NODE = "/br.usp.ime.ccsl.cogroo.oooext.CoGrOOImportFilter/Templates";
