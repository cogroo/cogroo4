  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    while (!input.equals("q")) {
        ...
        for (Span sentPos : sentPosArr) {
          ...
          System.out.println("PROP: " + new NameSample(toks, props, true).toString());
          
          Span[] exps = expFinder.find(toks);
          System.out.println("EXPS: " + new NameSample(toks, exps, true).toString());
          
          Span[] merged = merge(props, exps);
          toks = groupTokens(toks, merged);
          System.out.println("MERG: " + new NameSample(toks, merged, true).toString());
          ...
          System.out.println("CHKS: " + new ChunkSample(toks, filterPOS(posTags), chunks));

          String[] shallowParseChunks = shallowParser.chunk(toks, getShallowParserInTags(filterPOS(posTags), chunks));
          System.out.println("SHAL: " + new ChunkSample(toks, posTags, shallowParseChunks));
