...
public class SentenceCogroo extends Sentence {
	...
	public String getAnalysisAsString() {
		if (this.tokens.size() > 0 && this.tokens.get(0).getMorphologicalTag() == null) {
	...
	/**
	 * Returns the grammar check analysis as a table. Each row is composed of the analysis for one token of
	 * the sentence. The column order is Syntactic Tag, Chunk Tag, Lexeme, Primitive and Morphological Tag.
	 * 
