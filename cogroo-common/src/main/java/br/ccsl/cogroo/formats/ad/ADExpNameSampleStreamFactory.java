...
public class ADExpNameSampleStreamFactory extends
  ...
  public static void registerFactory() {
    StreamFactoryRegistry.registerFactory(ChunkSample.class, "adexp",
  ...
  public ObjectStream<NameSample> create(String[] args) {
    ...
    return new ADExpNameSampleStream(CmdLineUtil.openInFile(params.getData()),
        encoding.name(), tagSet);
  }
}
