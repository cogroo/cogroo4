...
private String mCat;
  ...
  public void initialize() throws ResourceInitializationException {
	  File input = new File(((String) getConfigParameterValue(PARAM_INPUT)).trim());
  ...
  public void getNext(CAS aCAS) throws IOException, CollectionException {
    ...
    if(mCat != null) { idPrefix += mCat + "_"; }
    idPrefix += mDocCount + "-";
    while(mLastEntry != null && sameCat(mLastEntry.getCategory(), mCat) && paragraphs < 100) {
