...
public class GoldenParagraph extends Annotation {
   ...
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(GoldenParagraph.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public int getId() {
    if (GoldenParagraph_Type.featOkTst && ((GoldenParagraph_Type)jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "cogroo.uima.GoldenParagraph");
    return jcasType.ll_cas.ll_getIntValue(addr, ((GoldenParagraph_Type)jcasType).casFeatCode_id);}
  ...
  public void setId(int v) {
    if (GoldenParagraph_Type.featOkTst && ((GoldenParagraph_Type)jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "cogroo.uima.GoldenParagraph");
    jcasType.ll_cas.ll_setIntValue(addr, ((GoldenParagraph_Type)jcasType).casFeatCode_id, v);}    
  }
