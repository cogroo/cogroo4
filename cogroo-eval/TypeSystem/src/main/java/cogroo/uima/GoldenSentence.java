...
public class GoldenSentence extends Annotation {
   ...
   */
  public String getId() {
    if (GoldenSentence_Type.featOkTst
        && ((GoldenSentence_Type) jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "cogroo.uima.GoldenSentence");
    return jcasType.ll_cas.ll_getStringValue(addr,
        ((GoldenSentence_Type) jcasType).casFeatCode_id);
  }
  ...
  public void setId(String v) {
    ...
    jcasType.ll_cas.ll_setStringValue(addr,
        ((GoldenSentence_Type) jcasType).casFeatCode_id, v);
  }
  ...
  public FSArray getGoldenGrammarErrors() {
    if (GoldenSentence_Type.featOkTst
        && ((GoldenSentence_Type) jcasType).casFeat_goldenGrammarErrors == null)
      jcasType.jcas.throwFeatMissing("goldenGrammarErrors",
          "cogroo.uima.GoldenSentence");
    return (FSArray) (jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas
        .ll_getRefValue(addr,
            ((GoldenSentence_Type) jcasType).casFeatCode_goldenGrammarErrors)));
  }
  ...
  public GoldenGrammarError getGoldenGrammarErrors(int i) {
    ...
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr,
        ((GoldenSentence_Type) jcasType).casFeatCode_goldenGrammarErrors), i);
    return (GoldenGrammarError) (jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas
