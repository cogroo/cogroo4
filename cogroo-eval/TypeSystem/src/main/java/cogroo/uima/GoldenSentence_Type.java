...
public class GoldenSentence_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  		     ...
  		     FeatureStructure fs = GoldenSentence_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		     ...
  		     return fs;
        } else return new GoldenSentence(addr, GoldenSentence_Type.this);
  	  }
    };
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("cogroo.uima.GoldenSentence");
  ...
  public int getGoldenGrammarErrors(int addr, int i) {
    ...
    if (lowLevelTypeChecks)
      return ll_cas.ll_getRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_goldenGrammarErrors), i, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_goldenGrammarErrors), i);
	return ll_cas.ll_getRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_goldenGrammarErrors), i);
  }
  ...
  public void setGoldenGrammarErrors(int addr, int i, int v) {
      ...
      jcas.throwFeatMissing("goldenGrammarErrors", "cogroo.uima.GoldenSentence");
    if (lowLevelTypeChecks)
      ll_cas.ll_setRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_goldenGrammarErrors), i, v, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_goldenGrammarErrors), i);
    ll_cas.ll_setRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_goldenGrammarErrors), i, v);
  }
  ...
  public GoldenSentence_Type(JCas jcas, Type casType) {
    ...
    casFeat_goldenGrammarErrors = jcas.getRequiredFeatureDE(casType, "goldenGrammarErrors", "uima.cas.FSArray", featOkTst);
    casFeatCode_goldenGrammarErrors  = (null == casFeat_goldenGrammarErrors) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_goldenGrammarErrors).getCode();
