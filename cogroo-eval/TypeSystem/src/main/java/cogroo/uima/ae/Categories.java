...
//	    elems.put("xml:116", null);
	    ...
	    RULES_AND_CATEGORIES = Collections.unmodifiableMap(elems);
		  ...
		  String[] allCatArr = {"abr","ace","adj","adv","aha","ali","arc","bde","cap","cjc","cli","cmt","con","cop","cov","cra","det","esp","est","ger","lex","mal","mec","mor","neo","nol","num","ond","ort","par","ple","pre","pro","prq","ptn","ptp","reg","ren","rep","res","sem","ver"};
		  
		  Set<String> allCat = Collections.unmodifiableSet(new HashSet<String>(Arrays.asList(allCatArr)));
	  ...
	  public static void printCategoriesByRules() {
		...
		System.out.println();
		System.out.println();
		String[] allCat = {"abr","ace","adj","adv","aha","ali","arc","bde","cap","cjc","cli","cmt","con","cop","cov","cra","det","esp","est","ger","lex","mal","mec","mor","neo","nol","num","ond","ort","par","ple","pre","pro","prq","ptn","ptp","reg","ren","rep","res","sem","ver"};
