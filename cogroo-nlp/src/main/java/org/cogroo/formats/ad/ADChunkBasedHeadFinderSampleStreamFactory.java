 ...
 */
public class ADChunkBasedHeadFinderSampleStreamFactory extends
  ...
  public static void registerFactory() {
    StreamFactoryRegistry.registerFactory(ChunkSample.class, "adheadfinder",
        new ADChunkBasedHeadFinderSampleStreamFactory(Parameters.class));
  }

  protected <P> ADChunkBasedHeadFinderSampleStreamFactory(Class<P> params) {
    super(params);
  }
