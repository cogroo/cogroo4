...
public class GrammarError_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (GrammarError_Type.this.useExistingInstance) {
        ...
        return new GrammarError(addr, GrammarError_Type.this);
    }
  };
  /** @generated */
  ...
  public final static boolean featOkTst = JCasRegistry
      .getFeatOkTst("cogroo.uima.GrammarError");
  ...
  public GrammarError_Type(JCas jcas, Type casType) {
    ...
    casFeat_ruleId = jcas.getRequiredFeatureDE(casType, "ruleId",
        "uima.cas.String", featOkTst);
    casFeatCode_ruleId = (null == casFeat_ruleId) ? JCas.INVALID_FEATURE_CODE
        : ((FeatureImpl) casFeat_ruleId).getCode();
