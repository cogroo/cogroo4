...
public class CogrooRuntimeException extends InternationalizedRuntimeException {
   ...
   *          arguments.
   */
  public CogrooRuntimeException(String aResourceBundleName, String aMessageKey, Object[] aArguments) {
   ...
   *          the original exception that caused this exception to be thrown, if any
   */
  public CogrooRuntimeException(String aMessageKey, Object[] aArguments, Throwable aCause) {
