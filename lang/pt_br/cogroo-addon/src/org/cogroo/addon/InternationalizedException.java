 ...
 * constructed using the {@link java.text.MessageFormat MessageFormat} class.
 * For more information on internationalization, see the <a
 * href="http://java.sun.com/j2se/1.4/docs/guide/intl/index.html"> Java
 ...
 * <code>InternationalizedException.java_1_4</code> is a version that uses the
...
public class InternationalizedException extends Exception {
   ...
   /**
    * Creates a new <code>InternationalizedException</code> with the specified
   ...
   public InternationalizedException(String aResourceBundleName,
      ...
      if (mResourceBundleName == null && mMessageKey == null) {
         if (mCause instanceof InternationalizedException) {
            mResourceBundleName = ((InternationalizedException) mCause)
            ...
            mResourceBundleName = ((InternationalizedRuntimeException) mCause)
                  .getResourceBundleName();
            mMessageKey = ((InternationalizedRuntimeException) mCause)
                  .getMessageKey();
            mArguments = ((InternationalizedRuntimeException) mCause)
                  .getArguments();
         }
      }
   }
